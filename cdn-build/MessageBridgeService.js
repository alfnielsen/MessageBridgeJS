...
var MessageBridgeService = (function () {
  ...
  MessageBridgeService.prototype.sendMessage = function (
    msg,
    onSuccess,
    onError
  ) {
    ...
    if (onSuccess || onError) {
      this.subscriptionTrackIdList[msg.trackId] = {
        onSuccess: onSuccess,
        onError: onError,
      };
    }
  ...
  MessageBridgeService.prototype.subscribeEvent = function (_a) {
    ...
    return function () {
      var index = _this.subscriptionEventList[name].findIndex(function (x) {
        return x === onEvent;
      });
      _this.subscriptionEventList[name].splice(index, 1);
    };
  };
  MessageBridgeService.prototype.createCommandMessage = function (
    name,
    payload,
    direction
  ) {
  ...
  MessageBridgeService.prototype.createQueryMessage = function (
    name,
    payload,
    direction
  ) {
  ...
  MessageBridgeService.prototype.createEventMessage = function (
    name,
    payload,
    direction
  ) {
  ...
  MessageBridgeService.prototype.subscribeQuery = function (opt) {
    ...
    return /*unsubscribe*/ function () {
      var index = _this.subscriptionQuery.findIndex(function (x) {
        return x === opt;
      });
      if (index > 0) {
  ...
  MessageBridgeService.prototype.handleIncomingMessage = function (messageDto) {
    ...
    if (this.subscriptionTrackIdList[msg.trackId]) {
      if (msg.type === MessageType.Error) {
        (_b = (_a = this.subscriptionTrackIdList[msg.trackId]).onError) ===
          null || _b === void 0
          ? void 0
          : _b.call(_a, msg.payload, msg);
      } else {
        (_d = (_c = this.subscriptionTrackIdList[msg.trackId]).onSuccess) ===
          null || _d === void 0
          ? void 0
          : _d.call(_c, msg.payload, msg);
      }
  ...
  MessageBridgeService.prototype.receiveEventMessage = function (eventMsg) {
    ...
    this.subscriptionQuery
      .filter(function (x) {
        var _a, _b;
        return (_b =
          (_a = x.triggers) === null || _a === void 0
            ? void 0
            : _a.some(function (x) {
                return x === eventMsg.name;
              })) !== null && _b !== void 0
          ? _b
          : false;
      })
  ...
  MessageBridgeService.prototype.internalSendMessage = function (msg) {
    ...
    (_a = this.connection) === null || _a === void 0
      ? void 0
      : _a.invoke("SendMessage", msgJson).catch(function (err) {
